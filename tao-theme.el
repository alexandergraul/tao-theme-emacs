...
(defun tao-apply-custom-theme (theme-name)
  (custom-theme-set-faces
   ...
   `(org-checkbox                                     ((t (:foreground ,color-10 :background ,color-4 :bold t ))))
   `(org-checkbox-statistics-todo                     ((t (:foreground ,color-10 :background ,color-4 :bold t ))))
   ...
   `(org-meta-line                                    ((t (:background ,color-4 :foreground ,color-9 :height ,(tao-theme-height 0.8)  :box ,(tao-boxed color-6)))))
   `(org-block-begin-line                             ((t (:background ,color-5 :foreground ,color-8 :height ,(tao-theme-height 0.8)  :box (:color ,color-1 :line-width 1 :style released-button )))))
   `(org-block-end-line                               ((t (:background ,color-3 :foreground ,color-6 :height ,(tao-theme-height 0.8) ))))
   ...
   `(org-block-background                             ((t (:foreground ,color-3 :height ,(tao-theme-height 0.8) ))))
   `(org-block                                        ((t (:background ,color-3  :height ,(tao-theme-height 0.8) ))))
   ...
   `(markdown-language-keyword-face                   ((t ( :height ,(tao-theme-height 0.8) :background ,color-8 :foreground ,color-1))))
   `(markdown-inline-code-face                         ((t ( :foreground ,color-13 ))))
   ...
   `(markdown-markup-face                             ((t (:foreground ,color-9 ))))
   `(markdown-html-attr-name-face                     ((t (:foreground ,color-9 ))))
   `(markdown-html-attr-value-face                 ((t (:foreground ,color-8 ))))
   `(markdown-html-tag-delimiter-face                 ((t (:foreground ,color-8 ))))
   `(markdown-html-tag-name-face                 ((t (:foreground ,color-9 ))))
   `(markdown-table-face                              ((t ( :height ,(tao-theme-height 0.8)))))
   ...
   `(circe-prompt-face                              ((t (:foreground ,color-1 :background ,color-9 ))))
